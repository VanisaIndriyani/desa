...
<head>
    ...
    <style>
        ...
        .topbar { background:linear-gradient(135deg,var(--raku-blue),var(--raku-blue-700)); color:#fff; box-shadow:0 10px 24px rgba(13,110,253,.25); }
        ...
        .sidebar { width:260px; background:linear-gradient(135deg, var(--raku-blue), var(--raku-blue-700)); color:#ffffff; box-shadow:0 18px 36px rgba(13,110,253,.25) inset; border-right:none; position:sticky; top:0; min-height:100vh; display:flex; flex-direction:column; flex:0 0 auto; }
        ...
        .sidebar-header { padding:1rem; border-bottom:1px solid rgba(255,255,255,.18); display:flex; align-items:center; gap:.75rem; }
        ...
        .main { flex:1; min-width:0; background:radial-gradient(800px circle at 10% -10%, rgba(13,110,253,.12), transparent 55%), #f8fafc; }
        .content { flex:1 1 auto; min-height:0; padding:24px; overflow-y:auto; }
        ...
        @media (max-width: 991.98px){
            .sidebar { position:fixed; left:0; top:56px; height:calc(100vh - 56px); transform:translateX(-100%); transition:transform .25s ease; z-index:1050; }
